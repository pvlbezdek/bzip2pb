...
/* Pre:
   ...
   Post:
      ((UChar*)arr1) [0 .. nblock-1] holds BWT of block
      s->origPtr set to BWT primary index
*/
void BZ2_blockSort ( EState* s )
{
   ...
   /* Compute the CYCLIC suffix array (rotation sort) via libsais on T+T.
      ...
      second copy is written into block[nblock..2*nblock-1], well within the
      allocation (2*nblock-1 < 4*nblock+136 for all nblock >= 0).
